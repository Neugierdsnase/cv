...
const skills: CvSection[] = [
  new CvSection('Markup', [
    ...
    { label: 'XML/JSON', level: 4, tags: ['frontend', 'backend'] },
    { label: 'JSX/TSX', level: 4, tags: ['frontend', 'backend'] },
    { label: 'Markdown', level: 4, tags: ['frontend'] },
    { label: 'Pug', level: 4, tags: ['frontend'] },
    { label: 'Jinja2', level: 3, tags: ['frontend', 'devops/sre'] },
    { label: 'Handlebars', level: 2, tags: ['frontend'] },
  ]),
  new CvSection('Styles', [
    { label: 'CSS', level: 4, tags: ['frontend'] },
    { label: 'Sass & SCSS', level: 4, tags: ['frontend'] },
    { label: 'styled-components & emotionJS)', level: 5, tags: ['frontend'] },
    { label: 'Tailwind CSS', level: 3, tags: ['frontend'] },
    { label: 'Material UI', level: 4, tags: ['frontend'] },
    { label: 'Bootstrap', level: 2, tags: ['frontend'] },
  ]),
  new CvSection('JavaScript', [
    { label: 'VanillaJS', level: 4, tags: ['frontend', 'backend'] },
  ...
  new CvSection('Other Things (kind of) I know', [
    ...
    { label: 'PHP für WordPress', level: 3, tags: ['frontend', 'backend'] },
    { label: 'Rust', level: 1, tags: ['frontend', 'backend'] },
    { label: 'GraphQL', level: 3, tags: ['frontend', 'backend'] },
    ...
    { label: 'CypressJS', level: 3, tags: ['tech health/monitoring'] },
    { label: 'SonarQube', level: 2, tags: ['tech health/monitoring'] },
    { label: 'Grafana', level: 2, tags: ['tech health/monitoring'] },
    { label: 'Prometheus', level: 1, tags: ['tech health/monitoring'] },
    { label: 'Sentry', level: 2, tags: ['tech health/monitoring'] },
    { label: 'Lighthouse', level: 3, tags: ['tech health/monitoring'] },
    { label: 'Storybook', level: 3, tags: ['frontend'] },
    { label: 'Agile Workflow', level: 3, tags: ['other'] },
    { label: 'Scrum', level: 3, tags: ['other'] },
    { label: 'Object-oriented programming', level: 3, tags: ['other'] },
    { label: 'Test-driven development', level: 3, tags: ['other'] },
  ...
  new CvSection('Sprachen', [
    ...
    {
      label: 'Englisch <i>(muttersprachliches Niveau)</i>', tags: ['non&#8209;tech'],
    },
    { label: 'Latein <i>(sehr hilfreich)</i>', tags: ['non&#8209;tech'] },
    {
      label: 'Altgriechisch <i>(noch viel hilfreicher)</i>', tags: ['non&#8209;tech'],
    },
    { label: 'Russisch <i>(A2)</i>', tags: ['non&#8209;tech'] },
  ]),
  new CvSection('schon wieder verlernte Skills', [
    { label: 'Adobe After Effects', tags: ['non&#8209;tech'] },
    { label: 'Adobe Illustrator', tags: ['non&#8209;tech'] },
    { label: 'Adobe InDesign', tags: ['non&#8209;tech'] },
    { label: 'Adobe Photoshop', tags: ['non&#8209;tech'] },
